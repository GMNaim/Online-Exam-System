...
$(document).ready(function () {
    ...
    $(".js-example-placeholder-multiple").select2({placeholder: "Select At least one"});
    ...
    $(".js-data-example-ajax").select2({
        ajax: {
            ...
            return markup;
        }, minimumInputLength: 1, templateResult: formatRepo, templateSelection: formatRepoSelection
    });
    $(".js-example-disabled-results").select2();
    $(".js-example-basic-hide-search").select2({minimumResultsForSearch: Infinity});
    $(".js-example-disabled").select2({disabled: false});
    ...
    $('.searchable').multiSelect({
        ...
        afterInit: function (ms) {
            var that = this, $selectableSearch = that.$selectableUl.prev(), $selectionSearch = that.$selectionUl.prev(),
